...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brass text-base hover:bg-brass-light shadow-[0_0_0_0_rgba(201,162,39,0.4)] hover:shadow-[0_0_28px_4px_rgba(201,162,39,0.35)]",
        outline:
          "border border-base-border text-ink hover:border-brass/60 hover:bg-base-surface2",
